...
//连接该设备回调
typedef void(^GNRBLEConnectBlock)(GNRPeripheral * peripheral,NSError * error);
//断开连接
typedef void(^GNRBLEDisConnectBlock)(GNRPeripheral * peripheral,NSError * error);
//搜索到该外设的指定的服务
typedef void(^GNRBLEDiscoverServiceCompletion)(GNRPeripheral * peripheral,GNRService * service,NSError * error);
//搜索到该外设的指定服务的指定特征
typedef void(^GNRBLEDiscoverCharacteristicCompletion)(GNRPeripheral * peripheral,GNRCharacteristic * characteristic,NSError * error);
//读外设的特征值回调
